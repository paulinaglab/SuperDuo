...
public class AlexandriaProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, AlexandriaContract.PATH_BOOKS + "/" + AlexandriaContract.PATH_FULLBOOK + "/#", BOOK_FULLDETAIL);
        matcher.addURI(authority, AlexandriaContract.PATH_BOOKS + "/" + AlexandriaContract.PATH_FULLBOOK, BOOK_FULL);
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case BOOK_FULLDETAIL:
                String[] bfd_projection = {
                        ...
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.COLUMN_TITLE,
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.COLUMN_SUBTITLE,
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.COLUMN_IMAGE_URL,
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.COLUMN_DESCRIPTION,
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.COLUMN_COLOR,
                        "group_concat(DISTINCT " + AlexandriaContract.AuthorEntry.TABLE_NAME + "." + AlexandriaContract.AuthorEntry.COLUMN_AUTHOR + ") as " + AlexandriaContract.BookEntry.COLUMN_AUTHORS,
                        "group_concat(DISTINCT " + AlexandriaContract.CategoryEntry.TABLE_NAME + "." + AlexandriaContract.CategoryEntry.COLUMN_CATEGORY + ") as " + AlexandriaContract.BookEntry.COLUMN_CATEGORIES
                };
    ...
    public Uri insert(Uri uri, ContentValues values) {
        Log.d(getClass().getSimpleName() + ".insert", uri.toString());
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        Log.d(getClass().getSimpleName() + ".delete", uri.toString());
        final SQLiteDatabase db = dbHelper.getWritableDatabase();
        final int match = uriMatcher.match(uri);
        int rowsDeleted;
        switch (match) {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        Log.d(getClass().getSimpleName() + ".update", uri.toString());
        final SQLiteDatabase db = dbHelper.getWritableDatabase();
        final int match = uriMatcher.match(uri);
        int rowsUpdated;
        switch (match) {
            ...
            case BOOK_FULL:
                ...
                break;
            case BOOK_FULLDETAIL:
                rowsUpdated = db.update(AlexandriaContract.BookEntry.TABLE_NAME, values, AlexandriaContract.BookEntry._ID + "=?",
